...
void MainWindow::processFile(const QString &FileName)
{
    ...
    // Launch analysis
    FileInformation* file = new FileInformation(signalServer, FileName, Prefs->ActiveFilters, Prefs->ActiveAllTracks, preferences->getActivePanels(), preferences->createCacheDirectoryFileNameString(FileName));
...
void MainWindow::addFile(const QString &FileName)
{
    ...
    // Launch analysis
    FileInformation* Temp=new FileInformation(signalServer, FileName, Prefs->ActiveFilters, Prefs->ActiveAllTracks, preferences->getActivePanels(), preferences->createCacheDirectoryFileNameString(FileName));
